...
export function Footer() {
    ...
    // Hide Footer on internal CRM routes
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
                    <div className="lg:col-span-1">
                        ...
                        <div className="flex space-x-6">
                            ...
                            <a href="https://www.tiktok.com/@fenixfitbytahicruzz" target="_blank" rel="noopener noreferrer" className="text-muted-light hover:text-primary transition-colors">
