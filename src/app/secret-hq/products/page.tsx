    ...
    return (
        <div className="space-y-12 animate-in fade-in slide-in-from-bottom-6 duration-1000">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 border-b border-white/5 pb-16">
                ...
                <button className="bg-white text-black px-10 py-5 text-[10px] font-black uppercase tracking-[0.2em] flex items-center space-x-3 hover:bg-white/90 transition-all shadow-[0_0_30px_rgba(255,255,255,0.1)]">
                    <Plus size={16} />
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-between items-center bg-[#0a0a0a] border border-white/5 p-6 rounded-sm">
                <div className="flex items-center bg-white/5 px-6 py-3 border border-white/5 w-full md:max-w-md">
                    ...
                    <input type="text" placeholder="Filtrar Archivo..." className="bg-transparent border-none focus:ring-0 text-[10px] font-black tracking-widest uppercase ml-4 w-full" />
                </div>
                ...
                {products?.map((product) => (
                    <div key={product.id} className="group bg-[#0a0a0a] border border-white/5 hover:border-white/20 transition-all duration-700 relative flex flex-col h-[520px]">
                        ...
                        <div className="relative h-[320px] overflow-hidden bg-[#111] p-4">
                            ...
                            <div className="absolute top-4 right-4 flex flex-col space-y-2 translate-x-12 group-hover:translate-x-0 transition-all duration-500">
                                <button className="w-10 h-10 bg-white text-black flex items-center justify-center shadow-2xl hover:bg-black hover:text-white transition-all">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center space-x-10 text-white/30 text-[9px] font-black uppercase tracking-widest">
                                    ...
                                    <div className="flex items-center">
                                        ...
                                        <span className={product.stock < 10 ? 'text-amber-400' : ''}>{product.stock} Uni</span>
                                    </div>
                                </div>
                                <button className="w-full border border-white/10 py-4 text-[9px] font-black uppercase tracking-[0.2em] group-hover:bg-white group-hover:text-black transition-all">
                                    Analizar Archivo
                                </button>
                            </div>
                        </div>
            ...
            {(!products || products.length === 0) && (
                <div className="py-40 flex flex-col items-center justify-center text-center">
                    ...
                    <p className="text-white/20 text-[10px] uppercase tracking-widest max-w-sm">No hay productos registrados en el sistema de HQ.</p>
                </div>
            )}
        </div>
    );
